-- ============================================
-- CARGA MASIVA DE DATOS GENERADOS AUTOMÁTICAMENTE
-- Para pruebas de carga (Fase 6) y replicación con volumen
-- Requiere que las tablas ya existan (correr dataset_completo.sql primero,
-- al menos una vez, para crear la estructura)
-- ============================================
...
-- 100 productos nuevos (usa categorías existentes; si no hay ninguna, categoria_id queda NULL)
...
-- ~4000 detalles de pedido (2 por cada pedido recién insertado)
...
-- ~2000 pagos (uno por pedido reciente)
